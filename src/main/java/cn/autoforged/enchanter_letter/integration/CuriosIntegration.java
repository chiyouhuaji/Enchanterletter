...
public class CuriosIntegration {
    ...
    private static boolean curioDropRuleRegistered = false;
        ...
        try {
            ...
            Object proxy = java.lang.reflect.Proxy.newProxyInstance(
                    ...
                    (obj, method, args) -> {
                        ...
                        // 死亡掉落规则：魔法绑定 KEEP（留在原槽位），强制消失 DESTROY
                        if ("getDropRule".equals(name)) {
                            ItemStack dropStack = null;
                            if (args != null && args.length > 0 && args[args.length - 1] instanceof ItemStack s) {
                                dropStack = s;
                            }
    ...
    /** Curios 原生 DropRule 是否已注册（注册成功后可不再手动摘除本模组饰品）。 */
    public static boolean isDeathDropRuleActive() {
        return LOADED && curioDropRuleRegistered;
    }
